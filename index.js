 ...
 * Copyright (c) 2023 - 2025 Leon Rosenplänter. 
...
function set_popover_content () {
    ...
    var keywords = [
        {keyword: "Sensitivity", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[0].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of likely successful candidates that are invited.</div><div class="col-md-6 p-1"><b>Synonyms</b>: '+content[0].synonyms+'</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[0].calculation+'</div></div>',
        ...
        {keyword: "Specificity", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[1].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of likely unsuccessful candidates that are not invited.</div><div class="col-md-6 p-1"><b>Synonyms</b>: '+content[1].synonyms+'</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[1].calculation+'</div></div>',
        ...
        {keyword: "False Alarm Rate", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[3].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of likely unsuccessful candidates that are invited.</div><div class="col-md-6 p-1"><b>Synonyms</b>: '+content[3].synonyms+'</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[3].calculation+'</div></div>',
        ...
        {keyword: "Positive Predictive Value", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[4].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of all positive test results that in fact represent likely successful candidates (true positive).</div><div class="col-md-6 p-1"><b>Synonyms</b>: '+content[4].synonyms+'</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[4].calculation+'</div></div>',
        ...
        {keyword: "Negative Predictive Value", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[5].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of all negative test results that in fact represent ikely unsuccessful candidates (true negative).</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[5].calculation+'</div></div>',
        ...
        {keyword: "False Discovery Rate", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[6].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of all positive test results that <i>do not</i> represent likely successful candidates (false positive).</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[6].calculation+'</div></div>',
        ...
        {keyword: "False Omission Rate", content: [
            ...
            '<div class="row"><div class="col-md-6 p-1"><b>Definition</b>: '+content[7].definition+'</div><div class="col-md-6 p-1"><b>Example</b>: The proportion of all negative test results that <i>do not</i> represent likely unsuccessful candidates, but likely successful candidates (false negative).</div><div class="col-md-6 p-1"><b>Calculation</b>: '+content[7].calculation+'</div></div>',
